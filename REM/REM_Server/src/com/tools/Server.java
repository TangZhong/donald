...
public class Server implements Runnable {
    ...
    public void registerNewUser() {
        ...
        try {            
			...
			String sql2 = "insert into GetPwdInfo(QUESTION,ANSWER,GQQ) values(?,?,"+newqq+")";
			...
			String sql3 = "insert into GetPwdInfo(QUESTION,ANSWER,GQQ) values(?,?,"+newqq+")";
			...
			String sql4 = "insert into GetPwdInfo(QUESTION,ANSWER,GQQ) values(?,?,"+newqq+")";
