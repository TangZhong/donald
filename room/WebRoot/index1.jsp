...
<html>
  ...
  %>
   ...
   <a href="qszusercenter.jsp">寝室信息展示</a><br>
    </fieldset>
     <fieldset>
    <legend>舍管基本操作</legend> <a href="manager/managerlogin.jsp">宿管登录</a><br> 
   <a href=".jsp">卫生检查情况</a><br> 
   <a href=".jsp">寝室报修情况</a><br>
   <a href=".jsp">公布寝室水电费</a><br>
    </fieldset>
