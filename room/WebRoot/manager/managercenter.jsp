     ...
     <c:if test="${not empty sessionScope.mname}">
        ...
        <fieldset>
             <legend>寝室评分管理</legend>
               <h3><a href="../manager/chengji.jsp" target="ifrm">对寝室进行评分</a></h3>
               <h3><a href="../manager/showchengji.jsp" target="ifrm">发布寝室评分情况</a></h3><br><br>
        </fieldset>
        <fieldset>
             <legend>寝室缺勤管理</legend>       
               <h3><a href="../manager/record.jsp" target="ifrm">记录学生缺勤情况</a></h3>
               <h3><a href="../manager/recordSave.jsp" target="ifrm">查找学生缺勤情况</a></h3><br><br>
