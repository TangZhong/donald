...
<html>
  ...
  <body>
   <div id="wrapper">
     <div id="header"><h1>寝室长用户中心</h1></div>
     <div id="main">
     <c:if test="${not empty sessionScope.uname}">
        <div id="left">
          <h2>欢迎您，${sessionScope.uname}！</h2>
          <h3><a href="user/Showuserinfo" target="ifrm">查看个人信息</a></h3>
          
          <h3><a href="modifyPass.jsp" target="ifrm">修改个人密码</a></h3>
          <h3><a href="qszsearch" target="ifrm">查看/修改寝室信息</a></h3>
          <h3><a href="user/FindUdormByUname" target="ifrm">查看寝室水电费用</a></h3>
          <h3><a href="Logoutservlet" target="_parents">退出登录</a></h3>
          <h3><a href="index2.jsp" >返回主页</a></h3>
       </div>
       <div id="content">
