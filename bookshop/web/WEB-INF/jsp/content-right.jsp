...
<%@ page language="java" import="com.serviceimpl.GoodsServiceImpl" %>
<%@ page language="java" import="com.serviceimpl.ShoppingCartServiceImpl" %>
<%@ page language="java" import="com.service.ShoppingCartService" %>
<%@ page language="java" import="net.sf.json.JSONObject" %>
<%@ page language="java" import="com.domain.ShoppingCart" %>
<%@ page language="java" import="com.domain.CartItem" %>
<%@ page language="java" import="org.apache.commons.codec.binary.Base64"%>
<%@ page language="java" import="com.dao.GoodsMapper" %>
