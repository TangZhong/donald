...
<div id="container">
  <div id="header">&nbsp; 网站后台管理<span class="STYLE2">{管理中心}</span>
  	<span>
  		<span class="STYLE4"><a href="index1.jsp">网站首页</a></span>
  		<span class="STYLE4"><a href="">安全退出</a></span>
  	</span>    
  ...
  <div id="mainContent">
    <div id="sidebar">
		<script type="text/javascript">				
			...
			d.add(0,-1,'后台管理');
//			d.add(1,0,'首页','system/index1.jsp',null,'contentFrame');
//			d.add(2,0,'用户管理');
...
//			d.add(5,4,'修改密码','system/user/updatePwd.jsp',null,'contentFrame');
			...
			d.add(12,0,'歌曲管理');
			d.add(13,12,'添加歌曲','add.jsp',null,'contentFrame');
			d.add(14,12,'歌曲列表','song',null,'contentFrame');
			// d.add(14,0,'专辑管理');
    ...
    <div id="content">
      <iframe name="contentFrame" id="contentFrame" src="index1.jsp" style="width: 1000px; min-height: 800px; border:none;">
