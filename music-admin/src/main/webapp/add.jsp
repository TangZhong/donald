   		...
   		<div class="content">
			<form action="song" method="post" enctype="multipart/form-data">
				<table class="addAlbumTable">
					<tr>
						<td >歌曲名：</td> <td><input type="text" name="songName" maxlength="25" required="required"/></td>
					</tr>
					<tr>
						<td >歌手：</td>
						<td>
							<input type="text" id="singer" maxlength="80" required="required" name="singerName"/>
						</td>
					</tr>
					<tr>
						<td >上传音频文件：</td><td><input type="file" name="songFile" required="required" /></td>
					</tr>
					<tr>
						<td >上传歌词文件：</td><td><input type="file" name="lrcFile" required="required"/></td>
					</tr>
					<tr>
						<td>歌曲描述：</td>
						<td>&nbsp;</td>
