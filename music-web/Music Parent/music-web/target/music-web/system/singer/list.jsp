...
<html>
  ...
  <body>
    <div class="content">
    	<!-- 分页条 -->
		<form action="sys/sysSinger_list" name="pageForm" method="post">
	    	...
	    	<div class="song-list">
				...
				<table class="m-table">
					...
					<tr class="ztag even">
						...
						<td  class="fourth_td">
							<c:if test="${singer.isValid=='1'}">启用</c:if>
							<c:if test="${singer.isValid=='0'}"><font style="color: red;">停用</font></c:if>
						</td>
						<td class="fifth_td">
							<%-- <a href="sys/toEditSinger?id=${singer.singerId}">编辑</a>
							<a href="javascript:void(0);">删除</a> --%>
							<img class="editImg" alt="编辑" title="编辑" lang="${singer.id}" src="images/other/037.gif" style="cursor: pointer;" width="12" height="12">&nbsp;&nbsp;
							<%-- <img class="delImg" alt="删除" title="删除" lang="${singer.id},${singer.name}"  src="images/other/010.gif" style="cursor: pointer;" width="12" height="12"> --%>
						</td>
					</tr>
					</c:forEach>					
					</tbody>
